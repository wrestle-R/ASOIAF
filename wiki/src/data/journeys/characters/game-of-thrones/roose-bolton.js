      ...
      "stops": [
        {
          ...
          "appearances": [
            {
              "episode": "S2E4",
              "scene": "The Westerlands — Oxcross; scene begins 0:03:55.",
              "source": {
            ...
            {
              "episode": "S2E6",
              "scene": "The Westerlands — Camp of the North; scene begins 0:41:50.",
              "source": {
            ...
            {
              "episode": "S2E7",
              "scene": "The Westerlands — Camp of the North; scene begins 0:18:54.",
              "source": {
            ...
            {
              "episode": "S2E8",
              "scene": "The Westerlands — Camp of the North; scene begins 0:33:50.",
              "source": {
      ...
      "stops": [
        {
          ...
          "appearances": [
            {
              "episode": "S3E1",
              "scene": "The Riverlands — Harrenhal; scene begins 0:23:32.",
              "source": {
            ...
            {
              "episode": "S3E2",
              "scene": "The Riverlands — Harrenhal; scene begins 0:05:05.",
              "source": {
            ...
            {
              "episode": "S3E5",
              "scene": "The Riverlands — Harrenhal; scene begins 0:12:24.",
              "source": {
            ...
            {
              "episode": "S3E6",
              "scene": "The Riverlands — Harrenhal; scene begins 0:31:25.",
              "source": {
        ...
        },
        {
          ...
          "appearances": [
            {
              "episode": "S3E9",
              "scene": "The Riverlands — The Twins; scene begins 0:29:25.",
              "source": {
            ...
            {
              "episode": "S3E10",
              "scene": "The Riverlands — The Twins; scene begins 0:01:55.",
              "source": {
      ...
      "stops": [
        {
          ...
          "appearances": [
            {
              "episode": "S4E2",
              "scene": "The North — The Dreadfort; scene begins 0:07:47.",
              "source": {
        ...
        },
        {
          ...
          "appearances": [
            {
              "episode": "S4E8",
              "scene": "The North — Moat Cailin; scene begins 0:33:04.",
              "source": {
        ...
        },
        {
          ...
          "appearances": [
            {
              "episode": "S4E8",
              "scene": "The North — Outside Winterfell; scene begins 0:35:19.",
              "source": {
                "title": "Game of Thrones S4E8: “The Mountain and the Viper” — HBO",
                "url": "https://www.hbo.com/game-of-thrones/season-4/8-the-mountain-and-the-viper"
              },
      ...
      "stops": [
        {
          ...
          "appearances": [
            ...
            {
              "episode": "S5E5",
              "scene": "The North — Winterfell; scene begins 0:29:07.",
              "source": {
      ...
      "stops": [
        {
          ...
          "appearances": [
            {
              "episode": "S6E1",
              "scene": "The North — Winterfell; scene begins 0:16:03.",
              "source": {
